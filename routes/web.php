...
Route::middleware(['auth'])
    ...
    ->group(function () {
        ...
        Route::get('/histori-pengajuan-ttd', [PengajuanTtdController::class, 'historiTtd'])->middleware('can:read.pengajuan.ttd')->name('mahasiswa.histori.pengajuan.ttd');
...
Route::middleware(['auth'])->prefix('dosen')->group(function () {
    ...
    Route::get('/pengajuan', [DosenPengajuanController::class, 'index'])->name('dosen.pengajuan.index');
});
